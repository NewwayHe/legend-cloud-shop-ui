...
<template>
    <section class="">
        <el-card shadow :body-style="{padding:`20px 20px 10px 20px`}">
            ...
            <div class="table">
                ...
                <el-row v-show="showSimilar" class="mb-20">
                    <el-alert class="theme" :closable="false" show-icon>
                        <p>参数：用于展示商品的一些具体的属性（例：产地、材料、包装方式等），用户可以根据参数值搜索到相关的商品</p>
                        <p>类似导入：选择已有的参数，并新增一个参数，自动填充选择的参数信息</p>
                    </el-alert>
                </el-row>
            ...
            <dialog-similar ref="similarDialog" url="/product/s/productProperty/page" attribute-type="P" @chooseItem="exportSimilar" />
        </el-card>
    </section>
</template>
<script>

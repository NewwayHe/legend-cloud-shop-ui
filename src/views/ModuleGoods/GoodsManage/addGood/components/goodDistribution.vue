		...
		<el-form ref="form" :model="value" label-width="132px" size="small">
			...
			<el-form-item label="商品限购：">
				<div class="d-flex text-nowrap">
					...
					<el-form class="flex-1" ref="quotaDTOFrom" :model="value.productQuotaDTO" size="small" v-if="value.productQuotaDTO.quotaType">
			...
			<div class="overflow-h" :style="{ height: isOpen ? '' : '0px' }">
				<el-form-item>
					...
					<el-radio style="margin-right: 0" v-model="value.preSellFlag" :label="true">是</el-radio>
				...
				<el-form-item>
					...
					<el-radio style="margin-right: 0" v-model="value.onSaleWay" :label="0">预约上架</el-radio>
				...
				<el-form-item>
					...
					<el-radio style="margin-right: 0" v-model="value.stockCounting" :label="true">付款减库存</el-radio>
				</el-form-item>

	...
	<section class="formWarp pl-20 pr-20">
		...
		<el-form ref="form" :model="value" :rules="rules" label-width="132px" size="small">
			...
			<el-form-item>
				...
				<lsInput class="w-450p" v-model="value.stocksArm" :min="1" :max="999999" :precision="0" textAlign="left"/>
			</el-form-item>
			<el-form-item>
				<span slot="label">
					商品品牌
				...
				<el-select class="w-450p" v-model="value.brandId" filterable placeholder="请选择" :disabled="!branchList.length">

                ...
                <el-col :span="12">
                    ...
                    <div class="mt-10 d-flex a-center">
                        ...
                        <div class="font-12">
                            ...
                            <p class="my-10">下单新用户{{couponUserAmountCount.orderNewUserCount || 0}}人， 占比：{{Number(couponUserAmountCount.orderNewUserRate).toFixed(2) ||0}}% </p>
                            <p>下单旧用户{{couponUserAmountCount.orderOldUserCount || 0}}人，占比：{{Number(couponUserAmountCount.orderOldUserRate).toFixed(2) ||0}}%</p>
                        </div>
                    </div>
                </el-col>

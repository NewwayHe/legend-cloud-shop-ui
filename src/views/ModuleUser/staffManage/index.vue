...
<template>
    <section class="">
		...
		<el-dialog title="修改密码" custom-class="dialog-form" width="420px" :visible.sync="editForm.isVisible" @close="resetEditForm">
		    <el-form :model="editForm.formData" :rules="editForm.formRule" label-width="95px" size="small" label-position="right" ref="editForm">
		    ...
		    <div slot="footer" class="dialog-footer">
		        ...
		        <ls-button type="primary" size="small" :asyncFunction="handleEditConfirm">确 定</ls-button>
		    </div>
		</el-dialog>
    ...
    methods: {
        ...
        handleEditConfirm() {
            return new Promise(async resolve=>{
                ...
                positionManage.staffUpdatePwd(this.editForm.formData).then((res) => {
                    if (res.code) {

	...
	<section class="">
		...
		<div class="">
			<el-card shadow>
					...
					<div class="d-flex p-20" style="background-color: #f5f7fa">
						<div class="flex-1">
							<div>
								...
								<el-form-item label="售后编号：" v-if="detailsInfo.orderAftersalesInformationDTO.applyType !== 3">
				...
				<!--列表-->
				<orderTable ref="table" :tableList="tableList" :orderInfo="detailsInfo" @printOrder="goOrderPrint" @refreshData="getDetailsInfo" />
				<el-row type="flex" justify="end" class="mt-20">
					<div class="check">
						...
						<div class="mb-20 flex-center" v-if="detailsInfo.changedPrice && detailsInfo.changedPrice != 0">
							<span class="settle-title">商家改价：</span>
							<span class="money">{{ detailsInfo.changedPrice > 0 ? '+' : '' }} {{ detailsInfo.changedPrice | priceFilter }}</span>
						</div>
						<div class="mb-20 flex-center" v-if="detailsInfo.orderType != 'SM'">
		...
		>
			<div class="d-flex">
				<el-form class="flex-1" ref="updateLogisticForm" :model="updateLogisticForm" label-width="98px" label-position="right" size="small">

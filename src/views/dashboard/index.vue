        ...
        <el-card shadow class="mb-15">
            ...
            <el-row type="flex" justify="center">
                <el-col class="p-25 w-20">
                    ...
                    <p class="font-weight font-28 mt-10 cursor-pointer" style="line-height:41px" @click="$router.push({name: 'order',query: {isDashboard: 3}})">{{ orderInfoList.waitDelivery || 0 }}</p>
                </el-col>
                <el-col class="p-25 w-20">
                    <div class="font-14 text-999 " style="line-height:16px">未付款订单数量</div>
                    <p class="font-weight font-28 mt-10 cursor-pointer" style="line-height:41px"  @click="$router.push({name: 'order',query: {isDashboard: 2}})">{{ orderInfoList.unPaid || 0 }}</p>
                </el-col>
                <el-col class="p-25 w-20">
                    <div class="font-14 text-999 " style="line-height:16px">未收货订单数量</div>
                    <p class="font-weight font-28 mt-10 cursor-pointer" style="line-height:41px" @click="$router.push({name: 'order',query: {isDashboard: 1}})">{{ orderInfoList.takeDeliver || 0 }}</p>
                </el-col>
                <el-col class="p-25 w-20">

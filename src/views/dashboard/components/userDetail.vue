    ...
    <div>
        ...
        <el-row type="flex" class="a-stretch">
                            ...
                            <el-col :span="12">
                                <div class="px-20 py-10">
                                    ...
                                    <div  class="font-14 text-999 d-flex j-start a-center mt-10" style="line-height: 16px">
                                        <span class="mr-15">较昨日</span>
                                        <img style="width: 16px; height: 16px" :src="paidOrderList.comparePaidOrderAmount > 0 ? upPic : downPic" alt />
            ...
            <el-col class="ml-15" style="width: 420px;">
                <div class="h-100 d-flex flex-column j-sb a-stretch">
                    <el-card shadow class="mb-15" v-if="publist&&publist.title">
                        <div slot="header" class="d-flex j-sb">
                            <span>公告</span>
                            <el-link class="text-blue" :underline="false" type="primary" @click="$router.push({ path: '/messageManage/message',query:{radioCur:1} })">
                                更多
                            </el-link>
                        </div>
                        <div class="d-flex j-sb a-center">
                            <div class="flex-1 font-14 text-222 line-clamp1" style="line-height: 21px; cursor: pointer;" @click="showDetails">{{publist.title}}</div>
                            <div class="font-14 text-999" style="line-height: 21px">{{publist.createTime?publist.createTime.substring(0,10):'--'}}</div>
                        </div>
                    </el-card>
                    <!-- 这里可以加flex-1 上面加了 这里就不能加 IE的stretch属性应该是选取一个盒子作为参照物 然后另一个盒子才可以使用flex-1 而不能两个盒子都使用flex-1 -->
                    <el-card class="flex-1" id="guide-step1">

    ...
    <section class="formWarp sku-data">
        <el-card v-loading="loading" shadow>
            <el-form ref="form" :model="form" :rules="rules" label-width="132px" size="small">
                ...
                <!-- //没有包邮 -->
                <template v-else>
                    <el-form-item v-if="type == '阶梯计价'" label="计费方式：" prop="transType">
                    ...
                    <el-form-item label="运费计算：">
                        <el-row>
                            <el-button v-if="type != '固定运费' && form.transFeeDTOList.length" @click="form.transFeeDTOList = []">
                                删除所有
                            </el-button>
                            <el-button v-if="type == '固定运费' && form.transConstFeeDTOList.length" @click="form.transConstFeeDTOList = []">
                                删除所有
                            </el-button>
                    ...
                    <el-form-item v-if="type != '固定运费'" label="条件包邮：" prop="conditionFreeFlag">
                        <el-row class="mb-20">
                            ...
                            <span v-if="form.conditionFreeFlag" class="ml-20">
                                <el-button v-if="form.transFreeDTOList.length" @click="form.transFreeDTOList = []">删除所有</el-button>
            ...
            <el-row type="flex" justify="center" class="w-100 overflow-h py-10 mt-10 bg-white">
                ...
                <ls-button size="small" type="primary" :async-function="onSubmit">确定</ls-button>
            </el-row>
        </el-card>
        <dialogAreaSelect
            ...
            :list-type="listType"
            :trans-free-d-t-o-list="freeDTOList"

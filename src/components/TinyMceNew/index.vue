<template>
    <div :class="['tinymce-container', { fullscreen: fullscreen }]">
        <vue-tinymce v-model="content" :setting="setting" :setup="setupCb" :disabled="disabled" @change="valChange" />
        <div class="editor-custom-btn-container">
            <!-- <editorImage color="#1890ff" class="editor-upload-btn" @successCBK="imageSuccessCBK" /> -->
            <imgCenter :disabled="disabled" :limit="15" :is-show-selected="false" button mult in-rich-text @input="imageSuccessCBK"></imgCenter>
        </div>
    </div>
</template>
